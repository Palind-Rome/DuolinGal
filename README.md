...
- 已完成最小 CLI：`analyze`、`init-project`、`list-tools`、`extract`、`decompile-scripts`、`preflight`、`build-lines`
- 已完成最小本地 API：健康检查、工具探测、目录分析、项目初始化、资源提取、脚本反编译、预检报告、`lines.csv` 构建
...
- [本机验证清单](docs/local-validation-checklist.zh-CN.md)
